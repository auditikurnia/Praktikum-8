...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["nopesujian"])) {
            $error_nopesujian = "Kolom no. peserta ujian tidak boleh kosong";
        } else {
            $nopesujian = cek_input($_POST["nopesujian"]);
            if (!is_numeric($nopesujian)) {
                $error_nopesujian = "Kolom no. peserta ujian hanya dapat diisi angka";
            }
        }

        if (empty($_POST["noserskhun"])) {
            $error_noserskhun = "Kolom nomor seri SKHUN tidak boleh kosong";
        } else {
            $noserskhun = cek_input($_POST["noserskhun"]);
            if (!is_numeric($noserskhun)) {
                $error_noserskhun = "Nomor seri SKHUN hanya dapat diisi angka";
            }
        }

        if (empty($_POST["noserijazah"])) {
            $error_noserijazah = "Kolom no. seri ijazah tidak boleh kosong";
        } else {
            $noserijazah = cek_input($_POST["noserijazah"]);
            if (!is_numeric($noserijazah)) {
                $error_noserijazah = "Kolom nomor Seri Ijazah hanya dapat diisi angka";
            }
        }
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" name="jenispend" value="Siswa Baru">Siswa Baru</label><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" name="appaud" value="Ya">Ya</label><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" name="aptk" value="Ya">Ya</label><br>
